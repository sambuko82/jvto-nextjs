...
export default function Page() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <JsonLd data={buildBreadcrumbSchema([{"name":"Home","url":"/"},{"name":"Contact JVTO","url":"/Contact"}])} />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-6 mt-8">Get in Touch</h2>
          ...
          <h2 className="text-2xl font-bold mb-6 mt-8">Response Time</h2>
